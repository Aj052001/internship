               ...
               <div className="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div class="btn-group">
                      ...
                      <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="javascript:void(0);">Filter by date</a></li>
                        <li><a class="dropdown-item" href="javascript:void(0);">Order id</a></li>
                        <li><a class="dropdown-item" href="javascript:void(0);">Distributor id</a></li>
                      </ul>
                    </div>
                  </div>
